...
class OpticalFlow(nn.Module):
    def __init__(self):
        ...
        # input: (16, 12), output: (32, 24)
        self.upConv2 = up_conv4x4(10, 10)
        # input: (32, 24), output: (64, 48)
        self.upConv3 = up_conv4x4(10, 10)
        # input: (64, 48), output: (128, 96)
        self.upConv4 = up_conv4x4(10, 10)
        # input: (128, 96), output: (256, 192)
        self.upConv5 = up_conv4x4(10, 10)
