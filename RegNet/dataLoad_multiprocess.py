...
def ypr2quat(ypr):
    ...
    print(ypr_half_cos)
    quat[0] = ypr_half_cos[2]*ypr_half_cos[1]*ypr_half_cos[0] + \
        ypr_half_sin[2]*ypr_half_sin[1]*ypr_half_sin[0]
    quat[1] = ypr_half_sin[2]*ypr_half_cos[1]*ypr_half_cos[0] + \
        ypr_half_cos[2]*ypr_half_sin[1]*ypr_half_sin[0]
    quat[2] = ypr_half_cos[2]*ypr_half_sin[1]*ypr_half_cos[0] + \
        ypr_half_sin[2]*ypr_half_cos[1]*ypr_half_sin[0]
    quat[3] = ypr_half_cos[2]*ypr_half_cos[1]*ypr_half_sin[0] + \
        ypr_half_sin[2]*ypr_half_sin[1]*ypr_half_cos[0]
...
def dataLoad_SUN3D(sequenceName, nFrame1, nFrame2, dataTopPath, verbose=False):
   ...
   # output['depth_second'] = np.array(output['depth_second'].reshape(img_height,img_width,1))
    ...
    if verbose:
        ...
        imwrite('depth_first.png', output['depth_first'])
        #scipy.misc.imwrite('depth_second.png',output['depth_second'] )
    ...
    while(True):
        ...
        if (frameID == frameIDAnother):
            ...
            output_tmp = dataLoad_SUN3D(
                dataDir, frameID, frameIDAnother, '', False)
